...
class EndpointsHandler:
    ...
    @classmethod
    def _add_endpoint(cls, method: str, url: str, endpoint_function: Callable) -> None:
    ...
    @classmethod
    def get(cls, url: str) -> Callable:
        """Decorator function to add endpoint to Handler"""

        def inner(endpoint_function: Callable) -> Callable:
            cls._add_endpoint(
    ...
    @classmethod
    def delete(cls, url: str) -> Callable:
        """Decorator function to add endpoint to Handler"""

        def inner(endpoint_function: Callable) -> Callable:
            cls._add_endpoint(
                method="DELETE", url=url, endpoint_function=endpoint_function
            )
            return endpoint_function
