...
from tests.ifrs.fixtures.example_data import EXAMPLE_METADATA, EXAMPLE_METADATA_BASE
from tests.ifrs.fixtures.module_scope_fixtures import (  # noqa: F401
    JointFixture,
    joint_fixture,
    kafka_fixture,
    mongodb_fixture,
...
async def test_happy_journey(
    ...
    for s3, strorage_alias in (
        ...
        file_metadata_base = EXAMPLE_METADATA_BASE.model_copy(
            update={"storage_alias": strorage_alias}, deep=True
        )
            ...
            events=[
                ExpectedEvent(
                    payload={
                        ...
                        "s3_endpoint_alias": strorage_alias,
                    },
